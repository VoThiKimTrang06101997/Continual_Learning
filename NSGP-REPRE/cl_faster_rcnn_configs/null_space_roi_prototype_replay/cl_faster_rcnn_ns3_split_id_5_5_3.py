_base_ = [
    ...
    f'../_base_/datasets/voc_5_5_task3_2007.py',
    '../_base_/schedules/schedule_1x_sgdnscl.py', '../_base_/brnsrunetime.py'
]

# ==================== THÊM LINK ĐỌC DATASET VÀ LƯU CHECKPOINT ====================
data_root = 'E:/NghienCuu/Continual_Learning/NSGP-REPRE/dataset/train/'
work_dir = 'E:/NghienCuu/Continual_Learning/NSGP-REPRE/work_dirs/checkpoints/ns3_split_id/ns3_split_id_5_5_3/'
# ========================================================
...
previous_dir = f'./work_dirs/checkpoints/ns3_split_id/cl_faster_rcnn_ns3_split_id_5_5_{task_id-1}'  # Cập nhật để trỏ đúng
